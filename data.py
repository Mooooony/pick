...
class dataProcess(object):
	...
	def __init__(self, out_rows, out_cols, data_path = "../deform/train", label_path = "../deform/label", test_path = "../test", npy_path = "../npydata", img_type = "jpg"):
	...
	def create_train_data(self):
		...
		for imgname in imgs:
			img = load_img(self.data_path + "/" + imgname,grayscale = True)
			label = load_img(self.label_path + "/" + imgname,grayscale = True)
